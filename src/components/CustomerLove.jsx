      ...
      <div className="max-w-screen-xl mx-auto px-8">
        ...
        <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {REVIEWS.map((review, index) => (
            <div
              key={review.name}
              className={`bg-surface-container-lowest p-10 rounded-xl shadow-sm border border-outline-variant/10 relative overflow-hidden hover-lift stagger-item ${gridVisible ? 'visible' : ''} ${index === 1 ? 'mt-0 md:mt-12' : ''}`}
